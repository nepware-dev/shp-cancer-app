...
export const PKCEValidationTypes = ['none', 'auto', 'always'];

/**
 * Used on the front-end to encode launch parameters
 */
export function encode(params: any, ignoreErrors = false): string {
 ...
 */
export function decode(launch: string) {
...
function decodeLegacy(object: Record<string, string>) {
  /**
